...
public class DataInit {
    ...
    void init() {
        ...
        user1.setEmail("seu@example.com");
        user1.setPassword(passwordEncoder.encode("123"));
        user1.setFamilyName("Thoeng");
        user1.setGivenName("Mengseu");
        ...
        user2.setEmail("reki@example.com");
        user2.setPassword(passwordEncoder.encode("password"));
        user2.setFamilyName("Thoeng");
        user2.setGivenName("Mengseu");
